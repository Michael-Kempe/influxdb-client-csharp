...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class GreaterThreshold : Threshold,  IEquatable<GreaterThreshold>
    {
        ...
        public GreaterThreshold(TypeEnum type = default(TypeEnum), float? value = default(float?), CheckStatusLevel? level = default(CheckStatusLevel?), bool? allValues = default(bool?)) : base(level, allValues)
        {
